...
Mat DevFilter::weighted_median(Mat img, float weight)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::minus_median(Mat img)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::laplacian(Mat img)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::minus_laplacian(Mat img)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::directional_north(Mat img)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::directional_east(Mat img)
{
	Mat aux = img.clone();
	const uint rows = img.rows;
	const uint cols = img.cols;
...
Mat DevFilter::grayscale_average(Mat img)
{
	Mat aux = img.clone();
...
Mat DevFilter::grayscale_luminosity(Mat img)
{
	Mat aux = img.clone();
...
Mat DevFilter::grayscale_luminance(Mat img)
{
	Mat aux = img.clone();
	int gray[3][3];
...
Mat DevFilter::gaussian(Mat img, float sigma)
{
	float	pre[3][3];
	int		mask[3][3], sum_mask = 0;
